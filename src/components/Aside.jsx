    ...
    <aside className="mt-[2rem] flex flex-col asideCard" >
      ...
      >
        ...
        >
          ...
          target="_blank"
          className="bg-blue-900 from-pink-500 to-orange-500 flex gap-[1rem] text-[1.3rem] font-semibold p-[1rem] rounded-md items-center text-white mt-[1rem] socBox facebook"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="32px"
